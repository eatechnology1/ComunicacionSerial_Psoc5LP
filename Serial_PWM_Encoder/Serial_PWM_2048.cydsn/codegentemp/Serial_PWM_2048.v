// ======================================================================
// Serial_PWM_2048.v generated from TopDesign.cysch
// 07/19/2024 at 10:05
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=1, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=1024, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=LPWM, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LPWM, CY_INSTANCE_SHORT_NAME=LPWM, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=LPWM, )
module PWM_v3_30_1 (
    capture,
    clock,
    cmp_sel,
...
module top ;
    ...
    PWM_v3_30_0 RPWM (
        ...
        .tc(Net_308),
        .trigger(1'b0));
    defparam RPWM.Resolution = 16;


	cy_clock_v1_0
		#(.id("d07d8fed-4411-4985-9d31-bbaee2b54009"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__R_PWM_net;
	wire [0:0] tmpFB_0__R_PWM_net;
	wire [0:0] tmpIO_0__R_PWM_net;
	wire [0:0] tmpINTERRUPT_0__R_PWM_net;
	electrical [0:0] tmpSIOVREF__R_PWM_net;

	cy_psoc3_pins_v1_10
		#(.id("c0fdf5b5-f7f2-4da3-8dd5-2ddf81441ff3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		R_PWM
		 (.oe(tmpOE__R_PWM_net),
		  .y({Net_23}),
		  .fb({tmpFB_0__R_PWM_net[0:0]}),
		  .io({tmpIO_0__R_PWM_net[0:0]}),
		  .siovref(tmpSIOVREF__R_PWM_net),
		  .interrupt({tmpINTERRUPT_0__R_PWM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__R_PWM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__L_PWM_net;
	wire [0:0] tmpFB_0__L_PWM_net;
	wire [0:0] tmpIO_0__L_PWM_net;
	wire [0:0] tmpINTERRUPT_0__L_PWM_net;
	electrical [0:0] tmpSIOVREF__L_PWM_net;

	cy_psoc3_pins_v1_10
		#(.id("2abae0c1-f9c9-454e-a699-f947b21ef9b5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		L_PWM
		 (.oe(tmpOE__L_PWM_net),
		  .y({Net_64}),
		  .fb({tmpFB_0__L_PWM_net[0:0]}),
		  .io({tmpIO_0__L_PWM_net[0:0]}),
		  .siovref(tmpSIOVREF__L_PWM_net),
		  .interrupt({tmpINTERRUPT_0__L_PWM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__L_PWM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    PWM_v3_30_1 LPWM (
        ...
        .tc(Net_332),
        .trigger(1'b0));
    defparam LPWM.Resolution = 16;

	wire [0:0] tmpOE__EN_L_net;
	wire [0:0] tmpFB_0__EN_L_net;
	wire [0:0] tmpIO_0__EN_L_net;
	wire [0:0] tmpINTERRUPT_0__EN_L_net;
	electrical [0:0] tmpSIOVREF__EN_L_net;

	cy_psoc3_pins_v1_10
		#(.id("f16e1485-b496-49e4-aa98-db7eb5e6b7aa"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		EN_L
		 (.oe(tmpOE__EN_L_net),
		  .y({Net_65}),
		  .fb({tmpFB_0__EN_L_net[0:0]}),
		  .io({tmpIO_0__EN_L_net[0:0]}),
		  .siovref(tmpSIOVREF__EN_L_net),
		  .interrupt({tmpINTERRUPT_0__EN_L_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__EN_L_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__EN_R_net;
	wire [0:0] tmpFB_0__EN_R_net;
	wire [0:0] tmpIO_0__EN_R_net;
	wire [0:0] tmpINTERRUPT_0__EN_R_net;
	electrical [0:0] tmpSIOVREF__EN_R_net;

	cy_psoc3_pins_v1_10
		#(.id("45d63d4e-e721-4b08-b4d1-23695373cb89"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		EN_R
		 (.oe(tmpOE__EN_R_net),
		  .y({Net_66}),
		  .fb({tmpFB_0__EN_R_net[0:0]}),
		  .io({tmpIO_0__EN_R_net[0:0]}),
		  .siovref(tmpSIOVREF__EN_R_net),
		  .interrupt({tmpINTERRUPT_0__EN_R_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__EN_R_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Timer_v2_80_4 Timer1 (
        ...
        .tc(Net_545),
        .trigger(1'b1));
    defparam Timer1.CaptureCount = 2;
    defparam Timer1.CaptureCounterEnabled = 0;
    defparam Timer1.DeviceFamily = "PSoC5";
    defparam Timer1.InterruptOnCapture = 0;
    defparam Timer1.InterruptOnTC = 0;
    defparam Timer1.Resolution = 24;
    defparam Timer1.SiliconRevision = "0";
