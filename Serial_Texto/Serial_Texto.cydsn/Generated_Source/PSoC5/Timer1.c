...
{
   #if(Timer1_UsingFixedFunction)
       return ((uint32)CY_GET_REG16(Timer1_PERIOD_LSB_PTR));
   #else
       return (CY_GET_REG24(Timer1_PERIOD_LSB_PTR));
   #endif /* (Timer1_UsingFixedFunction) */
}
...
void Timer1_WritePeriod(uint32 period) 
{
    ...
    #else
        CY_SET_REG24(Timer1_PERIOD_LSB_PTR, period);
...
{
   #if(Timer1_UsingFixedFunction)
       return ((uint32)CY_GET_REG16(Timer1_CAPTURE_LSB_PTR));
   #else
       return (CY_GET_REG24(Timer1_CAPTURE_LSB_PTR));
   #endif /* (Timer1_UsingFixedFunction) */
}
...
void Timer1_WriteCounter(uint32 counter) 
{
    ...
    #else
        CY_SET_REG24(Timer1_COUNTER_LSB_PTR, counter);
